...
func (c *Config) Redacted() *Config {
	...
	if c.PushGateway != nil {
		pg := *c.PushGateway
		pg.PushGatewayURL = c.PushGateway.PushGatewayURL.Redacted()
		if c.PushGateway.BasicAuth != nil {
...
func Init(config *Config, pricingManager *modelcatalog.ModelCatalog, logger schemas.Logger) (*PrometheusPlugin, error) {
	...
	if config.PushGateway != nil && config.PushGateway.Enabled && config.PushGateway.PushGatewayURL.GetValue() != "" {

...
const (
	...
	BifrostContextKeyMCPVirtualInstructions              BifrostContextKey = "bifrost-mcp-virtual-instructions"           // schemas.MCPVirtualInstructions (set by bifrost - DO NOT SET THIS MANUALLY) - the Virtual MCP's own instructions for a /mcp/<slug> request

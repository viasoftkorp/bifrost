...
This directory contains community-maintained data that powers parts of the Bifrost platform. Contributions are reviewed by maintainers and, once merged into the `dev` branch, are automatically synced to the live platform.
...
```
┌──────────────┐      PR       ┌──────────────┐     Merge      ┌──────────────┐
│  Contributor  │─────────────▶│   Review &    │──────────────▶│  dev branch  │
│  edits JSON   │              │   CI checks   │               │  (stable)    │
└──────────────┘              └──────────────┘               └──────┬───────┘
                                                                     │
                                                            Periodic sync
                                                                     │
...
2. **Review** — Maintainers and CI validate your submission.

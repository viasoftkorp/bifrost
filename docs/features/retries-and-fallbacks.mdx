...
<Note>
Key rotation on retries requires **v1.5.0-prerelease4 or later**. Rotation on auth/billing/permission errors (in addition to rate limits) requires the retry-logic-enhancements release.
</Note>

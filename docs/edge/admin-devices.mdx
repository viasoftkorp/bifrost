...
<Frame>
  <img src="/media/edge/admin-devices-list.png" alt="Bifrost Edge devices dashboard listing machines across the fleet" />
</Frame>
...
<Frame>
  <img src="/media/edge/admin-device-detail.png" alt="Device detail panel showing installed apps, MCP servers, and owner" />
</Frame>

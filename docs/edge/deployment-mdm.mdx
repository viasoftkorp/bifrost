...
<CardGroup cols={3}>
  ...
  <Card title="Microsoft Intune" icon="microsoft">
    Push Edge to Windows and macOS devices alongside your existing Intune policies.
  </Card>
...
<Frame>
  <img src="/media/edge/mdm-deployment.png" alt="Deploying Bifrost Edge through an MDM platform" />
</Frame>

...
The first time Edge runs, the user signs in through their browser using your organization's existing single sign-on. That sign-in links the machine to the person and assigns the virtual keys, budgets, and policies that belong to them. No API keys are copied or pasted, and nothing sensitive lives in the app itself.

<Frame>
  <img src="/media/edge/sign-in.png" alt="Bifrost Edge browser sign-in" />
</Frame>
...
<Frame>
  <img src="/media/edge/tray-menu.png" alt="Bifrost Edge menu-bar status and controls" />
</Frame>
...
<Frame>
  <img src="/media/edge/connected-status.png" alt="Bifrost Edge showing AI traffic routed and governed" />
</Frame>

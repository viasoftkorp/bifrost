...
<Frame>
  <img src="/media/edge/mcp-inventory.png" alt="Fleet-wide MCP server inventory in Bifrost" />
</Frame>
...
<Frame>
  <img src="/media/edge/mcp-allow-deny.png" alt="Allowing and denying MCP servers across the fleet" />
</Frame>

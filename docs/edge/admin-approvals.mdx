...
<Frame>
  <img src="/media/edge/admin-approvals-list.png" alt="Approvals dashboard showing app and MCP server catalogs with status" />
</Frame>
...
<Frame>
  <img src="/media/edge/admin-approvals-apps.png" alt="AI app catalog with approval controls" />
</Frame>
...
<Frame>
  <img src="/media/edge/admin-approvals-mcp.png" alt="MCP server catalog showing tools and approval controls" />
</Frame>

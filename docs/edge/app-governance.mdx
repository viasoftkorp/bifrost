...
<Frame>
  <img src="/media/edge/app-policy-admin.png" alt="Admin console for allowing or denying AI apps" />
</Frame>
...
<Frame>
  <img src="/media/edge/app-blocked-user.png" alt="User view when an AI app is blocked by policy" />
</Frame>

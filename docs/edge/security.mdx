...
<Frame>
  <img src="/media/edge/security-chatgpt-web.png" alt="A guardrail applied to a ChatGPT web prompt through Bifrost Edge" />
</Frame>

### IntelliJ

AI requests from an assistant inside IntelliJ pass through the same guardrails, so code, credentials, and internal data are protected without the developer changing anything.

<Frame>
  <img src="/media/edge/security-intellij.png" alt="A guardrail applied to an AI request from IntelliJ through Bifrost Edge" />
</Frame>
...
<Frame>
  <img src="/media/edge/security-cowork.png" alt="A guardrail applied to AI activity in CoWork through Bifrost Edge" />
</Frame>
